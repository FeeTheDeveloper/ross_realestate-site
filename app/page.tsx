      ...
      <section className="container-site flex min-h-[85vh] flex-col justify-center gap-10 py-20">
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          <SignatureMotion
            ...
            isButton
            type="button"
            className="inline-flex items-center justify-center rounded-full border border-bronze bg-bronze px-6 py-3 text-sm font-semibold uppercase tracking-[0.25em] text-jet transition"
          >
          ...
          <SignatureMotion
            ...
            isButton
            type="button"
            className="inline-flex items-center justify-center rounded-full border border-warm-ivory/40 px-6 py-3 text-sm font-semibold uppercase tracking-[0.25em] text-warm-ivory transition"
          >
        ...
        <div className="container-site space-y-10">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {[
              ...
              <div key={item.title} className="rounded-2xl border border-warm-ivory/10 bg-jet/60 p-6">
        ...
        <div className="container-site grid gap-10 lg:grid-cols-[1.2fr_1fr]">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-warm-ivory">
              Whether you are securing a penthouse retreat or listing a landmark estate, Tross 3rd
              Realtor delivers high-authority guidance with a steady hand.
            </p>
          </div>
          <div className="rounded-2xl border border-warm-ivory/15 bg-charcoal/60 p-8">
            ...
            <p className="mt-4 text-lg text-ivory">Accepting a limited number of private clients.</p>
            <SignatureMotion
              as="button"
              animateOnLoad={false}
              isButton
              type="button"
              className="mt-8 inline-flex w-full items-center justify-center rounded-full border border-bronze bg-bronze px-6 py-3 text-sm font-semibold uppercase tracking-[0.25em] text-jet"
            >
